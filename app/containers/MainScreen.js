    ...
    <SafeAreaView style={styles.mainTabContainer}>
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            source={route === 'Home' ? images.home_icon_en : images.home_icon}
            style={styles.tabImage}
          />
          <Text style={[styles.tabText, {color: themes[theme].menuText}]}>
            {I18n.t('Home')}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          ...
          <Image
            source={
              route === 'Profile' ? images.profile_icon_en : images.profile_icon
            }
            style={styles.tabImage}
          />
          <Text style={[styles.tabText, {color: themes[theme].menuText}]}>
        ...
        <TouchableOpacity
          ...
          <Image
            source={
              route === 'Message' ? images.message_icon_en : images.message_icon
            }
        ...
        <TouchableOpacity
          ...
          <Image
            source={
              route === 'Activity'
                ? images.activity_icon_en
                : images.activity_icon
            }
            style={styles.tabImage2}
          />
          <Text style={[styles.tabText, {color: themes[theme].menuText}]}>
        ...
        <SafeAreaView style={[styles.container, style]}>
          ...
          {showVipScreen && (
            <VipScreen
              theme={theme}
              width={width}
              onClose={() => this.setState({showVipScreen: false})}
              navigation={navigation}
            />
          )}
        </SafeAreaView>
