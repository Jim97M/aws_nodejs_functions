  ...
  return (
    <NavigationContainer
      ...
      <Stack.Navigator
        ...
        <>
          {root === ROOT_SPLASH ? (
            <Stack.Screen name="Splash" component={OutsideStack} />
          ) : null}
          {root === ROOT_LOADING ? (
            <Stack.Screen name="AuthLoading" component={SplashView} />
          ) : null}
          {root === ROOT_OUTSIDE ? (
            <Stack.Screen name="OutsideStack" component={AuthLoadingView} />
          ) : null}
          {root === ROOT_INSIDE ? (
            <Stack.Screen name="OutsideStack" component={InsideStack} />
          ) : null}
